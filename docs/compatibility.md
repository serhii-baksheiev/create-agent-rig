...
The same decision covers Ruler, Superpowers and vendoring — a single status
column, like the external-subsystem contract above, because these are product
choices rather than per-harness capabilities.
