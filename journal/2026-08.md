...
- **reviewed** — #78 was reviewed twice, and its rounds are what this session has to
  ...
  🔴 **The rounds spent on the branch carrying this entry are on PR #79, not here, and
  the omission is the finding.** Every earlier draft of this bullet enumerated them, and
  ...
  a branch actually had. Both branches at 3 in that file arrived there differently, and
  nothing in the file says which — the ambiguity AR-100 was filed to remove.
