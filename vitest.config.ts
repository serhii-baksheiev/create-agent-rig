    ...
    projects: [
      ...
      },
      {
        test: {
          ...
          // pins the two equal). Tests here spawn stub `gh` subprocesses; under a full
          // parallel `pnpm test` with e2e beside them, four crossed vitest's 5 s
          // default while passing alone (AR-143).
          testTimeout: 15_000,
        },
      },
      {
